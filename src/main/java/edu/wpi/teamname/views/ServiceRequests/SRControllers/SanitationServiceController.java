...
public class SanitationServiceController extends AbsRequest
            ...
            public void handle(ActionEvent event) {
              ...
              try {
                popUpAction(
                    ...
                    HomeController.disableRequestStatus);
              } catch (IOException e) {
                e.printStackTrace();
              }
              submitDia.close();
  ...
  public void initialize(URL url, ResourceBundle rb) {
    ...
    RequiredFieldValidator issueDescriptionValid = new RequiredFieldValidator();
    issueDescriptionValid.setMessage("Enter description of issue");
    issueDescription.getValidators().add(issueDescriptionValid);
    issueDescription
        .focusedProperty()
        .addListener(
            (o, oldVal, newVal) -> {
              if (!newVal) issueDescription.validate();
            });
