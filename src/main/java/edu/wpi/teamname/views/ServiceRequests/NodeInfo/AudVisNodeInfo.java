...
public class AudVisNodeInfo extends RecursiveTreeObject<AudVisNodeInfo> {
  ...
  public StringProperty descriptionOfProblem = new SimpleStringProperty();

  public AudVisNodeInfo(
      String id,
      String status,
      String firstName,
      String lastName,
